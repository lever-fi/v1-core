...
async function main() {
  ...
  const purchaseAgent = await ethers.getContractAt(
    "PurchaseAgent",
    "0xf04f1f5173491aC26079a451Ffe3D013AA733F67"
  );
  ...
  const data = ethers.utils.AbiCoder.prototype.encode(
    ...
    [
      [
        ...
        ethers.BigNumber.from("0"), // consideration identifier (identifier/criteria - 1st entry)
        ethers.BigNumber.from("195000000000000000"), // consideration amount (1st entry)
        ...
        ethers.BigNumber.from("2"), // order type
        ...
        "0x0000007b02230091a7ed01230072f7006a004d60a8d4e71d599b8104250f0000", // fulfiller conduit key -- same as offerer conduit key
        ethers.BigNumber.from("1"), // original additional recipients (len - 1)
        [
          // ignore 1st entry
          [
